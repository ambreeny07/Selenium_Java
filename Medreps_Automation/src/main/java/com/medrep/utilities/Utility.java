...
import com.medrep.errorCollectors.ErrorCollector;
...
public class Utility extends ErrorCollector {
	...
	public static final int defaultTimeForVisibility = 60;
	public static final int defaultTimeTOBeClickable = 60;
	...
	public static final String excelFileName = "testData";
...
//	}
	...
	public String getElementAttribute(WebElement element, String attribute, WebDriver driver) {
	...
	public void scrollDownSlightly(WebDriver driver) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("scroll(0,250)");
	}
...
//		action.moveToElement(element).click().perform();
	...
	public boolean isElementPresent(By status, WebDriver driver) {
		try {
			WebDriverWait waitClickable = new WebDriverWait(driver, Long.parseLong("5"));
			waitClickable.until(ExpectedConditions.presenceOfElementLocated(status));
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	public Object[][] getData(String filename, String SheetName, WebDriver driver) {
		...
		if (SheetName.equals("ActiveCandidateLoginCredential") | SheetName.equals("EmployerValidCredential")) {
			...
			for (int rowNum = 2; rowNum <= rows; rowNum++) {
				String excelEnv = excel.getCellData(SheetName, 2, rowNum).toString();
				if (excelEnv.equals(env)) {
...
//		ErrorCollector.extentLogInfo("Quitting browser");
	...
	public static void closeOtherTabs(WebDriver driver) {
		try {
	...
	public static String getUniqueEmailId(String value, WebDriver drive) {

		SimpleDateFormat formatter = new SimpleDateFormat("MMddyyHmmss");
		Date date = new Date();
		String unique = formatter.format(date).toString();
	...
	public static String getUniqueEmailGmailId(String value, WebDriver drive) {

		SimpleDateFormat formatter = new SimpleDateFormat("MMddyyHmmss");
		Date date = new Date();
		String unique = formatter.format(date).toString();
		String uniqueEmailId = value + unique + "@Gmail.com";
		return uniqueEmailId;
	}
	...
	public Object[][] loadExcel(String fileName, String sheetName, String env, WebDriver driver) {
		...
		assertTrue(dataIndex > -1, "Verified Excel sheet '" + sheetName + "' has data for '" + env + "' environment");
	...
	public void deleteDownloadFile(WebDriver driver) {
		try {
	...
	public static void shiftWindowHandle(WebDriver driver, int val) {
	...
	public ArrayList<Integer> getSortedIntegerList(ArrayList<Integer> symbol) {
		Collections.sort(symbol);
		return symbol;
	}

	public void hoverToElement(WebElement element, WebDriver driver) {
		Actions builder = new Actions(driver);
		builder.moveToElement(element).perform();
		waitTime(3000);
	}

	public String getDaysBetweenTwoDate(String startDate, String endDate, String dateFormat) {
...
//	        LocalDate endDate = LocalDate.of(2022, 2, 1);
		...
		String daysBetween = Long.toString(days);
		return daysBetween;
	}
